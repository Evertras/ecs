...
public:
	bool MoveUpPressed() const { return KeyPressed(SDL_SCANCODE_K); }
	bool MoveDownPressed() const { return KeyPressed(SDL_SCANCODE_J); }
	bool MoveRightPressed() const { return KeyPressed(SDL_SCANCODE_L); }
	bool MoveLeftPressed() const { return KeyPressed(SDL_SCANCODE_H); }

	bool EditTileUpPressed() const { return !ControlHeld() && KeyPressed(SDL_SCANCODE_E); }
	bool EditTileDownPressed() const { return !ControlHeld() && KeyPressed(SDL_SCANCODE_D); }
	bool EditTileRightPressed() const { return !ControlHeld() && KeyPressed(SDL_SCANCODE_F); }
	bool EditTileLeftPressed() const { return !ControlHeld() && KeyPressed(SDL_SCANCODE_S); }
	...
	bool EditLevelSavePressed() const { return ControlHeld() && KeyPressed(SDL_SCANCODE_S); }
	bool EditLevelLoadPressed() const { return ControlHeld() && KeyPressed(SDL_SCANCODE_O); }
