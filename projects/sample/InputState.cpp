...
{
	auto mouseState = SDL_GetMouseState(&m_MouseState.screenX,
	                                    &m_MouseState.screenY);
	...
	glm::vec4 screenPos(static_cast<float>(m_MouseState.screenX),
	                    static_cast<float>(m_MouseState.screenY), 0, 1);
